...
export default function ContactUs() {
    ...
    return (
        <>
            <div className="bg-[#f7fdf7]"><Header /></div>
            <div className="min-h-screen bg-[#f7fdf7] py-12 px-4">
                    ...
                    <div className="bg-white shadow-lg rounded-lg p-8">
                        <div className="space-y-4 mb-8">
                            ...
                            <p className="text-gray-600">
                                Interested in viewing our available land properties? Fill out the form below to schedule a visit or request more information about our listings.
                            </p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                className="w-full md:w-auto px-6 py-3 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition duration-200 ease-in-out"
                            >
                                Send Request
                            </button>
                        </form>

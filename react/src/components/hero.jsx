        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2 space-y-6 ">
            ...
            <p className="text-lg text-gray-700 max-w-xl w-130">
              ...
              With a deep commitment to nature and our clients, we help you find
              the perfect piece of land while preserving our natural heritage.
            </p>
            ...
            <div className="space-y-4 max-w-md mt-30">
              ...
              <p className="text-sm text-gray-600">
                By clicking 'Book a Free Tour Trip' you acknowledge that you
